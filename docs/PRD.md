...
Promessa-base: organizar a entrada em quatro decisões: Produto, Criadores de conteúdo,
Conteúdo e Escala, antes de comprometer estoque, equipe e mídia.
...
- no máximo dois "containers visuais" (papel claro/editorial e papel escuro/produto) e
  três papéis de card;
- HTML semântico primeiro, CSS em cascade layers e JS ES Modules, sem framework de
  runtime; ScrollReveal 4.0.9 é a única biblioteca de motion e fica restrita a
  `data-motion`; os trilhos contínuos preservam seus controladores aprovados;
...
| 03 | CNT-003 | Como o método tira minha operação da dúvida? | Mapa aprofundado das quatro decisões (Produto, Criadores de conteúdo, Conteúdo, Escala) | Conteúdo-base aprovado; não deve repetir o teaser do Hero |
